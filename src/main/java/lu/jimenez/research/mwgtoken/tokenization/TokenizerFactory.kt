 ...
 */
package lu.jimenez.research.mwgtoken.tokenization
...
import lu.jimenez.research.mwgtoken.tokenization.tokenizer.*
...
class TokenizerFactory(var tokenizerType: String) {
    ...
    fun create(toTokenize: String, typeOfToken: String? = null): Tokenizer {
        ...
        else tokenizer.setTypeOfToken(CoreConstants.NO_TYPE_TOKENIZE)
        return tokenizer
    }
