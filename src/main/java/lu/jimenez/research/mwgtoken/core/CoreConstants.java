 ...
 */
package lu.jimenez.research.mwgtoken.core;
...
public final class CoreConstants {
    ...
    public final static String VOCABULARY_NODE_NAME = "Vocabulary";

    public final static String VOCABULARY_TOKEN_INDEX = "Token";
